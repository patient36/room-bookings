...
const Home: NextPage = () => {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      >
        <div
          className="relative flex items-center justify-around h-screen bg-black/60"
        >
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-2xl mx-auto">
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <input
                  ...
                  className="p-3 border border-gray-300 rounded-lg text-black w-full sm:w-2/5"
                />
                <button className="bg-blue-600 cursor-pointer text-white p-3 rounded-lg hover:bg-blue-700 w-full sm:w-1/5">
                  Search
                </button>
              </div>
            </div>
